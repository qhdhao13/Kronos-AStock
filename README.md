...
For this fork, see [`examples/predict_000338_finetuned.py`](examples/predict_000338_finetuned.py) and the Chinese guide [`docs/000338使用指南.md`](docs/000338使用指南.md).

Upstream example scripts are available in [shiyu-coder/Kronos](https://github.com/shiyu-coder/Kronos).


## 🔧 Finetuning (This Fork)

This fork uses **CSV-based finetuning** under `finetune_csv/` (not Qlib). For A-share stock **000338**:
...
See **[README.zh-CN.md](./README.zh-CN.md)** and **[docs/000338使用指南.md](./docs/000338使用指南.md)** for the full workflow (Chinese Web UI, data download, backtest, forward prediction).

For the upstream Qlib finetuning pipeline, refer to [shiyu-coder/Kronos](https://github.com/shiyu-coder/Kronos).
